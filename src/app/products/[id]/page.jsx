...
const ProductDetailsPage = async ({ params }) => {
    ...
    if (!product.title) {
        return <div className="p-10 text-center text-red-500">পণ্যটি খুঁজে পাওয়া যায়নি!</div>;
    }
        ...
        <div className="container mx-auto px-4 py-10">
                ...
                <div className="flex flex-col">
                    ...
                    <div className="flex items-center gap-4 mb-6">
                        <div className="flex items-center text-yellow-500">
                            <FaStar /> <span className="ml-1 text-gray-700 font-medium">{product.ratings}</span>
                        </div>
                        <span className="text-gray-400">|</span>
                        <span className="text-gray-600">{product.reviews} Reviews</span>
                        <span className="text-gray-400">|</span>
                        <span className="text-blue-600 font-medium">{product.sold} Sold</span>
                    </div>

                    {/* Price section */}
                    <div className="mb-6 bg-gray-50 p-4 rounded-lg">
                        <div className="flex items-center gap-3">
                            <span className="text-3xl font-bold text-blue-700">৳{discountedPrice}</span>
                            {product.discount > 0 && (
                                <>
            ...
            <div className="mt-12 grid grid-cols-1 lg:grid-cols-3 gap-8">
                <div className="lg:col-span-2">
                    <h2 className="text-2xl font-bold mb-4 border-b pb-2">Product Description</h2>
                ...
                <div className="bg-gray-50 p-6 rounded-xl">
                    <h2 className="text-xl font-bold mb-4 border-b pb-2">Common Questions</h2>
